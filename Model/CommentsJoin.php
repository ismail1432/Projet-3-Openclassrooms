...
class CommentsJoin extends Model
{
    ...
    public function setDateTimeAddComment($dateTimeAddComment)
    {
        $this->_dateTimeAddComment = $dateTimeAddComment;
    }
    ...
    public function setAlertComment($alertComment)
    {
        $this->_alertComment = $alertComment;
    }

    // Setter mailMember => Modifie l'attribut correspondant au mail du membre ayant poster le commentaire
    public function setMailMember($mailMember)
    {
        $this->_mailMember = $mailMember;
    }
    ...
    public function dateTimeAddComment()
    {
        return $this->_dateTimeAddComment;
    }
