...
class ControlerComment
{
    ...
    public function decisionComment($get)
    {
        ...
        } elseif (isset($get['comment']) && ($get['comment'] == "on") && (isset($get['idTicket']))) { // On souhaite afficher les commentaires d'un chapitre
            $this->displayCommentsTicket($get);
        } elseif (isset($get['alertComments']) && ($get['alertComments'] == 'on')) { // On souhaite afficher les commentaires signaler
